...
final class FlexZContentView: FlexView {
...
final class FlexZStackView: FlexView {
    private let _contentView = FlexView()

    let contentView = FlexZContentView()
